...
const title = 'Nuñez Gallardo Gimena Soledad';
...
const redesSociales = [
  { id: 1, name: 'linkedin', src: linkedin, url: 'https://ar.linkedin.com/in/gimena-soledad-nu%C3%B1ez-gallardo-029b9ab4/' },
  { id: 2, name: 'Instagram', src: instagram, url: 'https://www.instagram.com/gimenanunezgallardo/' },
  { id: 3, name: 'github', src: github, url: 'https://github.com/Gimenanunezgallardo' },
  { id: 4, name: 'curriculum', src: cv, url: '' },
];
const telefono = '+54 379 4252878';
</script>
