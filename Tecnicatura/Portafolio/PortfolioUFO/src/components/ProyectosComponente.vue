<script setup>
import proyecto1 from '/src/assets/Psint.png';
import proyecto2 from '/src/assets/Java.png';
import proyecto3 from '/src/assets/block.png';
import proyecto4 from '/src/assets/futuro.png';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Juegos de preguntas PSint",
        descripcion: "Creamos una aplicación de preguntas y respuesta sobre distintos lenguajes de programación en PSint",
    ...
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Juegos de preguntas JAVA",
        descripcion: "Creamos una aplicación de preguntas y respuesta sobre distintos lenguajes de programación en JAVA",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Portafolio Grupal",
        descripcion: "Generamos este proyecto de portafolio grupal basado en las enseñanzas de la tecnicatura",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
...
.galeria {
    ...
    background: linear-gradient(to right, #330d53c8, #7a3b7f, #330d53c8);
