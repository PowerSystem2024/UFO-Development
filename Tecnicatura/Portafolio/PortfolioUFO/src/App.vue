...
import Educacion from './components/IntegranteComponente.vue';
...
<template>
    ...
    <main>
        ...
        <section id="educacion">
            <h2>Integrantes - Un poco de nosotros</h2>
            <!--Componente Educación-->
            <Educacion />
        </section>
        <section id="experiencia">
            <h2>Experiencias del Equipo</h2>
    ...
    <footer>
        <a href="#top">Inicio</a>
        <p>© 2024 UFO-Development - Portafolio web - Trabajo Final - UTN FRSR</p>
    </footer>
</template>
