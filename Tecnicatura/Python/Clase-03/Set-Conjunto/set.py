...
conj0 = {'Creiste que la frase iba a imprimirse ordenada?, recuerda que los conjuntos no mantienen el orden de sus elementos, ;)'}

conjunto1 = set() # Se puede inicializar vacio
conjunto2 = {'bye'} # No se puede inicializar vacio, es decir, no se puede inicializar como conjunto2 = {} <--------------
conjunto1.add(7)
conjunto1.add("Hola")
print(conjunto1)

#conjunto1.add(7, 8, 9)#No se pueden agregar varios elementos con el ".add" (esto da error)
