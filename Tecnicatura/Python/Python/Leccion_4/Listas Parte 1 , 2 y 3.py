# lista = Valentin , Facu, Pedro, Hector
# Colecciones en Python

# Las lista es lo que se conoce en otros lenguajes como arreglos o vectores
"""
nombres = ["Valentin", "Facu", "Pedro", "Hector"]
print(nombres)
print(nombres[0])
print(nombres[1])
print(nombres[3])
...
# Eliminar, borrar o limpiar todo los elementos
nombres.clear()
print(nombres)
...
"""
"""
# Ejercicio 3: Iterar un rango de 0 a 10 e imprimir numeros divisible entre 3
# Ejemplo de ejecucion: 0,3,6,9
print("Rango de 0 a 10 con numeros divisible entre 3")
for i in range(11):
    if i % 3 == 0:
        print(i)
...
del planetas
# print(planetas) # al eliminar nos muestra fue error
...
# Otras manera de acceder a un diccionario
...
lista3.extend([7, 8, 9, 1]) # Funcion para agragar varios elementos a una lista
print(lista3)

print(lista3.index(5)) # Funcion para ubicar en que indice esta el valor ingresado
# print(lista3.index(0)) # esto daria un error por nos ser elemento parte de la lista
...
print(conjunto3.issuperset(conjunto2)) # Si es verdadero quiere decir que el conjunto es un superconjunto
...
diccionario2 = {"Valentin": {"Edad": 18, "Altura": 1.76}, "Oscar": [25, 1.80], "Mari": [20, 1.79]}
print(diccionario2)

seleccionArgentina = {
    10: {"Nombre": "Lionel Messi", "Edad": 37, "Altura": 1.70, "Precio": "50 Millones", "Posicion": "Extremo Derecho"},
    11: {"Nombre": "Angel Di Maria", "Edad": 36, "Altura": 1.78, "Precio": "12 Millones", "Posicion": "Extremo Derecho"},
    21: {"Nombre": "Paulo Dybala", "Edad": 30, "Altura": 1.77, "Precio": "35 Millones", "Posicion": "Media Punta"},
    19: {"Nombre": "Nicolas Otamendi", "Edad": 36, "Altura": 1.83, "Precio": "3.5 Millones", "Posicion": "Defensa Central"},
    23: {"Nombre": "Damián Emiliano Martínez", "Edad": 32, "Altura": 1.95, "Precio": "21 Millones", "Posicion": "Portero"},
}
...
cola = ["Valentin", "Oscar", "Mari", "Pilar"]
